package id.co.endang.mynotesapp.adapter;
...
import id.co.endang.mynotesapp.CustomOnItemClickListener;
import id.co.endang.mynotesapp.NoteAddUpdateActivity;
import id.co.endang.mynotesapp.R;
